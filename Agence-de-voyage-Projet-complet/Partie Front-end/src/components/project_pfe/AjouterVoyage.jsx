...
export default function AjouterVoyage() {
    ...
    const Ajouter = async () => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/Ajouter-voyage', voyageData);
            if (response.status === 201) {
                const voyageId = response.data.voyage.idVoyage;
                for (let i = 0; i < ListVoyageDisponible.length; i++) {
                    ...
                    await axios.post(`http://127.0.0.1:8000/api/AjouterVoyageDispo/${voyageId}`,formData);
                }
                setmessage('Votre Voyage a été bien ajouté');
            }
        } catch (error) {
        ...
        <div className="container mt-4">
            <div className="row">
                <div className="col-12 py-5">
                    ...
                    <form encType="multipart/form-data">
                        <h5>Ajouter Voyage disponible :</h5>
                    <div className="row">
                            <div >
