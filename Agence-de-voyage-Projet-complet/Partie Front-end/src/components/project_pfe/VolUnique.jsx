...
export default function Aff(){
    ...
    const Vol = vols.find((i)=>i.idVol == id)
    const DateAjourdhui = new Date();
    console.log(dataReservationDispo)
    useEffect(()=>{
        axios.get(`http://127.0.0.1:8000/api/AfficherListVolDispo/${id}`).then((resp)=>{
    ...
    const ReservD = (ReserDispo) =>{
        navigate('/reservation-vol',{state:{dataReservationDispo:ReserDispo}})
    }
    return <div>
            <div>
                <Fade top>
            <div className="row px-5 hubqalbifati">
                <div className="col-8">
                    <div className="Omrifati">
                        <span> <i class="bi bi-geo-alt-fill"></i> {Vol.nomVille} {' '} <i class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i> <i class="bi bi-star"></i></span><br />
                    </div>
                    <div className="fati">
                        <img src={`http://127.0.0.1:8000/storage/${Vol.image}`}/>
                    </div>
                </div>
                <div className="col-4 fati2">
                    <div className="pr"><b className="">A partir de <br /> <span className="prixVoyage">{Vol.prix}</span> MAD <br /> Par Personne</b></div>
                    <br />
                    <br />
                    <div className="kk">
                        <div className="row">
