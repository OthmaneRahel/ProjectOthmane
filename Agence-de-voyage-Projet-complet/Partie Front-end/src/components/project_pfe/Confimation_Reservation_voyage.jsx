...
export default function ConfirmationReservationVoyage() {
    ...
    const filterVoy = voy.find((e)=>e.idVoyage == liD.idVoyage);
    console.log(liD)
    const [C,setC]=useState([]);
    // const voy = useSelector((state) => state.voyages);
    // const filterVoy = voy.filter((i) => i.RevervationDispo.find((v) => v.idR === id));
        ...
        <div className="row hh">
                ...
                <div className="col-6 mybabefati">
                    ...
                    <div className="d-grid">
                        <button  className="btn btn-warning btn-block" onClick={() => { add(); generatePDF(); }}>Je reserve</button>
                    </div>
                </div>
